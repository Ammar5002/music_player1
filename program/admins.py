...
@Client.on_message(
    command(["stop", f"stop@{BOT_USERNAME}", "end", f"ايقاف", "يقاف"])
    & other_filters
)
@authorized_users_only
...
@Client.on_message(
    command(["pause", f"pause@{BOT_USERNAME}", "vpause", f"اقف", "وقف"]) & other_filters
)
@authorized_users_only
...
@Client.on_message(
    command(["mute", f"mute@{BOT_USERNAME}", "vmute", f"يوت", "ميوت"]) & other_filters
)
@authorized_users_only
